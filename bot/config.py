class config:
    ...
    G_DRIVE_CLIENT_ID = "1039082056986-2g53ct9ahnhm5kpakd5qcdvuog0960fj.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "e7vBLch7X6lRRxLTxYca0mC2"
